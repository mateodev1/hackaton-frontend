          ...
          <div style="font-family: system-ui, -apple-system, sans-serif;">
            <h3 style="margin: 0 0 8px 0; font-size: 16px; font-weight: 600; color: #1f2937;">
              ...
              <p style="margin: 4px 0;"><strong>Status:</strong> 
                <span style="
                  background-color: ${shipment.status === 'In Transit' ? '#dbeafe' : shipment.status === 'In Port' ? '#d1fae5' : '#fee2e2'};
                  color: ${shipment.status === 'In Transit' ? '#1e40af' : shipment.status === 'In Port' ? '#065f46' : '#991b1b'};
                  padding: 2px 6px;
                  border-radius: 4px;
                  font-size: 12px;
                  font-weight: 500;
